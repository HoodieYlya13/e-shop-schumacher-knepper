...
export async function getShopDeliveryPolicies(): Promise<Policies> {
  return {
...
export async function getShopGeneralPolicies(): Promise<Policies> {
  return {
...
export async function getShopAboutUs(): Promise<{ content: string }> {
  return {
    content:
