    ...
    return (
      ...
      >
        <div className="w-full h-7/10 transition-all duration-500 ease-in-out group-hover:h-0 flex items-center justify-center">
          <div className="relative w-full h-full transform transition-transform duration-700 group-hover:scale-120">
        ...
        <div className="relative w-full h-3/10 transition-all duration-500 ease-in-out group-hover:h-full">
          <div className="absolute flex flex-col justify-between inset-0 p-4 shadow-[0_-25px_50px_-12px_rgb(0_0_0_/_0.25)] rounded-b-2xl">
